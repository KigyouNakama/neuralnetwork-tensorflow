...
def build_graph(
    ...
    print("rnn_inputs shape", rnn_inputs.get_shape()) # rnn_inputs shape (256, ?, 64)
    # RNN
...
def train_graph(g, batch_size = 256, num_epochs = 10, iterator = PaddedDataIterator):
